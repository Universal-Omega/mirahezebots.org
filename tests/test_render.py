...
def test_title_xss():
    ...
    assert '<title></title><img src=1 href=1 onerror="javascript:alert(1)"></img></title>' not in content
    assert '<title>&lt;/title&gt;&lt;img src=1 href=1 onerror=&#34;javascript:alert(1)&#34;&gt;&lt;/img&gt;</title>' in content
